  ...
  const MetricBar = ({ label, score, invert = false, description }: { label: string, score: number, invert?: boolean, description?: string }) => (
    <div className="space-y-2 group">
      ...
      <div className="h-2 w-full bg-slate-200 rounded-full overflow-hidden">
        <div 
          className={`h-full ${getScoreColor(score, invert)} opacity-90`} 
          style={{ width: `${score}%` }} 
        />
      </div>
    </div>
    ...
    <Layout>
      <div className="space-y-8 max-w-5xl mx-auto">
        <div>
          ...
          <p className="text-slate-500 mt-2 text-lg">Data-driven scoring based on your profile, historical success, and extracted scope.</p>
        </div>
            ...
            <CardContent className="relative z-10 flex flex-col items-center justify-center py-12">
              <div className="relative flex items-center justify-center h-48 w-48">
                ...
                <div className="absolute flex flex-col items-center justify-center">
                  ...
                  <span className="text-xs text-[#0A8A8F] font-bold uppercase tracking-widest mt-2 bg-teal-50 px-2 py-1 rounded-full border border-teal-200">Strong Fit</span>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="pt-6">
              <div className="flex flex-col md:flex-row items-start md:items-center gap-6 p-5 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC]">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-lg text-slate-900">100% Document Readiness</p>
                  <p className="text-sm text-slate-500 mt-1 leading-relaxed">Your company profile has all required bonding, insurance, and licensing verified and on file for this specific client and jurisdiction.</p>
                </div>
