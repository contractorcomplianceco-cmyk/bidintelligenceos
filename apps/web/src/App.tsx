...
function App() {
  ...
  // Landing-page "Launch Demo" buttons open the demo modal first (when the
  // walkthrough is active). "Enter Demo" inside the modal is the only path
  // into the dashboard; the X returns to the landing page.
  const handleLaunch = () => {
