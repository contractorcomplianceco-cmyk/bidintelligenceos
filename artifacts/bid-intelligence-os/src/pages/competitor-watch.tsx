  ...
  return (
    <Layout>
      <div className="space-y-6 max-w-[1600px] mx-auto">
        ...
        <Card className="bg-gradient-to-br from-[#0F1830] to-[#111A2E] border-[#1C253B] overflow-hidden relative">
          ...
          <CardContent className="p-6 lg:p-8 relative z-10">
            <div className="flex flex-wrap items-center gap-3 mb-3">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-[#A855F7]/15 text-[#c084fc] border border-[#A855F7]/30 px-3 py-1 text-[10px] font-bold uppercase tracking-widest">
                <Sparkles className="w-3 h-3" />
                {COMPETITORWATCH.status}
              </span>
              <span className="inline-flex items-center gap-1.5 rounded-full bg-[#0BA3A8]/10 text-[#5eead4] border border-[#0BA3A8]/30 px-3 py-1 text-[10px] font-bold uppercase tracking-widest">
                <ShieldCheck className="w-3 h-3" />
                Lawful signals only
              </span>
            </div>
            <h2 className="text-2xl lg:text-4xl font-bold text-white flex items-center gap-3 tracking-tight">
              <Crosshair className="h-8 w-8 text-[#A855F7]" />
              {COMPETITORWATCH.name}
            </h2>
            <p className="text-[#38BDF8] font-medium mt-2">{COMPETITORWATCH.tagline}</p>
            <p className="text-[#8A96B0] mt-3 max-w-3xl leading-relaxed">
          ...
          <CardContent className="p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {COMPETITORWATCH.whyItMatters.map((reason) => (
                <div
                  key={reason}
                  className="flex items-start gap-3 rounded-lg border border-[#1C253B] bg-[#0A0E1A]/50 p-3"
                >
                  <CheckCircle2 className="w-4 h-4 text-[#22C55E] shrink-0 mt-0.5" />
                  <p className="text-[12px] text-[#c3ccdd] leading-relaxed">{reason}</p>
                </div>
              ))}
            </div>
          </CardContent>
          ...
          <CardContent className="p-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {COMPETITORWATCH.features.map((feature) => (
                <div
                  key={feature.title}
                  className="relative rounded-xl border border-[#1C253B] bg-[#0A0E1A]/50 p-4 overflow-hidden"
                >
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <h4 className="text-sm font-semibold text-white leading-snug pr-6">
                      {feature.title}
                    </h4>
                  ...
                  <span className="mt-3 inline-block text-[9px] font-bold uppercase tracking-widest text-[#c084fc]">
                    Coming soon
                  </span>
                </div>
              ))}
        ...
        {/* Guardrails */}
        <Card className="bg-[#0F1830] border-[#0BA3A8]/30">
          <CardContent className="p-4 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[12px] text-[#8A96B0] leading-relaxed max-w-4xl">
        ...
        {/* Waitlist */}
        <Card id="waitlist" className="bg-gradient-to-br from-[#111A2E] to-[#0F1830] border-[#1C253B]">
          <CardHeader className="p-4 border-b border-[#1C253B]">
            <CardTitle className="text-sm font-bold text-white tracking-wide flex items-center gap-2">
          ...
          <CardContent className="p-6">
            {joined ? (
              <div className="flex flex-col items-center text-center gap-3 py-6">
                ...
                <p className="text-[12px] text-[#8A96B0] max-w-md leading-relaxed">
              ...
              <form onSubmit={handleJoin} className="max-w-2xl">
                <p className="text-[12px] text-[#8A96B0] leading-relaxed mb-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    <label
                      htmlFor="cw-email"
                      className="block text-[10px] font-bold uppercase tracking-widest text-[#8A96B0] mb-1.5"
                    >
                      Work email
                    </label>
                    <input
                      ...
                      className="w-full rounded-lg border border-[#1C253B] bg-[#0A0E1A] px-3 py-2.5 text-sm text-white placeholder:text-[#5b6680] focus:outline-none focus:border-[#A855F7] transition-colors"
                    />
                  </div>
                  <div>
                    <label
                      ...
                      className="block text-[10px] font-bold uppercase tracking-widest text-[#8A96B0] mb-1.5"
                    >
                      Company <span className="text-[#5b6680] normal-case">(optional)</span>
                    </label>
                    <input
                      id="cw-company"
                      type="text"
